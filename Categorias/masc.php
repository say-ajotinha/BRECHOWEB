...
// Consulta para buscar apenas produtos masculinos que não foram comprados
$query = "SELECT * FROM produtos WHERE genero = 'Masculino' AND (id_comprador IS NULL OR id_comprador = '')";
...
<head>
    ...
    <title>Moda Masculina - Brechó Sustentável</title>
...
<main>
    <section class="banner">
        ...
        <p>Encontre as melhores peças masculinas sustentáveis!</p>
    </section>
